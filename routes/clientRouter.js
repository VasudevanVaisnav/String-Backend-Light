...
const getContactsDraft = require("../handlers/getContactsDraft");//Done
...
router.post('/sendmsg',sendmsg);//verified
router.post('/refreshtoken',refreshToken);//verified
router.post('/gettoken',getToken);//verified
router.post('/getcontacts',/*getContacts*/getContactsDraft);//verified
